          ...
          <div class="row w-100 mx-0">
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                ...
                <form class="pt-3" action="{{ route('register_user') }}" method="POST">
                  @csrf
                  @if (session('success'))
                  ...
                  <div class="mt-3 d-grid gap-2">
                    <button type="submit" class="btn btn-block btn-primary btn-lg fw-medium auth-form-btn">Đăng Ký</button>
                  </div>
                  <div class="text-center mt-4 fw-light"> Bạn đã có tài khoản? <a href="{{ route('user_login') }}" class="text-primary">Login</a>
                  </div>
                </form>
              </div>
            </div>
