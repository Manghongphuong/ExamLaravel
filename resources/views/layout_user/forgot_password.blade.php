          ...
          <div class="row w-100 mx-0">
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                ...
                <h6 class="fw-light"> Nhập email.</h6>
                <form class="pt-3" action="{{ route('password.email.user')}} " method="POST">
                  @csrf
                  ...
                  <div class="mt-3 d-grid gap-2">
                    <button type="submit" class="btn btn-block btn-primary btn-lg fw-medium auth-form-btn"> Gửi liên kết</button>
                  </div>
                  </div>
                </form>
              </div>
