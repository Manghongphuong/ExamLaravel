          ...
          <div class="row w-100 mx-0">
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                ...
                <h6 class="fw-light">Tiếp tục đăng nhập</h6>
                <form class="pt-3" action="{{ route('login_user') }}" method="POST">
                  @csrf
                  @if (session('success'))
                  ...
                  <div class="my-2 d-flex justify-content-between align-items-center">
                    <a href="{{ route('forgot_password_user') }}" class="auth-link text-black">Quên Mật Khẩu</a>
                  </div>
                  <div class="text-center mt-4 fw-light"> Không có tài khoản? <a href="{{ route('user_register') }}" class="text-primary">Đăng Ký</a>
                  </div>
                </form>
              </div>
            </div>
