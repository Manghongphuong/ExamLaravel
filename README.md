...
## Chức năng của StarAmin

- Chức năng đăng ký, đăng nhập, đăng xuất -> Midellware, Authentication
- Chức năng danh mục, sản phẩm, blog, thành viên -> CRUD - resource
- Chức năng gửi email
    + Cấu hình .env
        <!-- MAIL_MAILER=smtp
        MAIL_HOST=smtp.gmail.com
        MAIL_PORT=587
        MAIL_USERNAME=hp205125@gmail.com
        MAIL_PASSWORD=olsgmxdxduyejryd
        MAIL_ENCRYPTION=tls
        MAIL_FROM_ADDRESS="hp205125@gmail.com"
        MAIL_FROM_NAME="PHUONG SO CUTE" -->
    + Tạo Mail -> php artisan mke:mail
    + Tạo controller cho Mail
